...
class URLAppendingQueryItemsTests: XCTestCase {
    func testQueryItemsAreFormEncoded() throws {
        let url = try XCTUnwrap(URL(string: "ws://localhost:4000/socket"))
        let query = [
        ...
        let expected = "ws://localhost:4000/socket?shared_secret=tfa7DS9iIX%2FPOq9%2FlAiIK4UZS%2BFXca1uQFMqfvJdpXY8zMUGF2vWEFXtotGcIMED"
